    ...
    */
    ...
    set_pbEnabled : function (bVal) {
        ...
        if (this._hInputField && !(this.pbReadOnly && this.isEnabled())) {
            ...
            this._hInputField.tabIndex = (bVal ? 0 : -1);
        }
    },
    ...
    set_pbReadOnly : function(bVal){
        ...
        if (this._hInputField && !(!this.pbReadOnly && !this.isEnabled())) {
            this._hInputField.contentEditable = !this.pbReadOnly;
            this._hInputField.tabIndex = (!this.pbReadOnly ? 0 : -1);
        }
    },
    ...
    encode: function (sValue) {
        ...
        Object.keys(htmlEscapes).forEach(function (sEscape) {
            sValue = sValue.replaceAll(sEscape, htmlEscapes[sEscape]);
        });
    ...
    onKey: function (oEvent) {
        ...
        if (!oEvent.bCanceled) {
            if (oEvent.matchKey(oKeys.escape) && this._bSuggestVisible) {
                ...
                if (oEvent.matchKey(oKeys.backSpace) && this.getSearchValue().length <= 1) {
                    this.suggestLoad();
                }
            }
