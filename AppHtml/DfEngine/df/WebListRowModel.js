...
rowHtml : function(tRow, aHtml, bZebra){
    ...
    aHtml.push('<table data-dfisrow="true" data-dfrowid="', (tRow ? tRow.sRowId : "empty"), (this.oL.pbDragDropEnabled  && this.oL.isSupportedDragAction(df.dragActions.WebList.ciDragRow) ? '" draggable="true"' : '" '), '" class="',  this.rowClass(tRow, bZebra),'" style="width:', this.sTableWidth, '">');
...
cellHtml : function(oCol, tRow, tCell){
    ...
    sHtml = tRow && tRow.fCellHtml ? 
                tRow.fCellHtml.call(oCol, tCell) : 
                oCol.cellHtml(tCell);
