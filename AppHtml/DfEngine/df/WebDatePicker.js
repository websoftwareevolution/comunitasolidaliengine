...
onMonthClick : function(oEvent){
    ...
    hide = function hide(){
        ...
        df.dom.off("click", eMenu, onClick);
        df.dom.off("mouseover", eMenu, onOver);
        df.dom.off("mouseout", eMenu, onOut);
...
onYearClick : function(oEvent){
    ...
    hide = function hide(){
        ...
        df.dom.off("mouseover", eMenu, onOver);
        df.dom.off("mouseout", eMenu, onOut);
        df.dom.off("mousedown", eUp, onScroll);
        df.dom.off("mouseout", eUp, onScrollStop);
        df.dom.off("mouseup", eUp, onScrollStop);
        df.dom.off("mousedown", eDown, onScroll);
        df.dom.off("mouseout", eDown, onScrollStop);
